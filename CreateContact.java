...
public class CreateContact {
	public static void main(String[] args) {
		...
		driver.get("http://leaftaps.com/opentaps/control/login");
		 ...
		 driver.findElement(By.id("firstNameField")).sendKeys("p");
		 driver.findElement(By.id("lastNameField")).sendKeys("Elango");
		 ...
		 driver.findElement(By.name("description")).sendKeys("I am a testerr");
		 driver.findElement(By.id("createContactForm_primaryEmail")).sendKeys("elango96@gmail.com");
